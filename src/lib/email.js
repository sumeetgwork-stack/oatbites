...
export async function sendOrderConfirmationEmail(order) {
  ...
  const bodyContent = `
    ...
    <table style="width: 100%; border-collapse: collapse; margin: 20px 0;">
      ...
      <tfoot>
        <tr>
          <td colspan="2" style="padding: 16px; text-align: right; font-weight: 600; color: #2c1810;">Total:</td>
          <td style="padding: 16px; text-align: right; font-weight: 800; font-size: 18px; color: #2c1810;">₹${order.total?.toLocaleString('en-IN')}</td>
        </tr>
      </tfoot>
    </table>
